...
<h1 id="headings" class="sg-heading">Templates</h1>
<div class="row">
	<div class="col-md-4">
		<ul>
			<li><a href="404.php">404 <i class="fa fa-flag"></i></a></li>
			<li><a href="academics.php">Academics <i class="fa fa-flag"></i></a></li>
			<li><a href="areas-of-study.php">Areas of Study <i class="fa fa-flag"></i></a></li>
			<li><a href="campus-landing.php">Campus Landing <i class="fa fa-flag"></i></a></li>
			<li><a href="campus-map.php">Map <i class="fa fa-flag"></i></a></li>
		</ul>
	</div>
	<div class="col-md-4">
		<ul>
			<li><a href="gateway.php">Gateway <i class="fa fa-flag"></i></a></li>
			<li><a href="giving-landing.php">Giving Landing <i class="fa fa-flag"></i></a></li>
			<li><a href="index.php">Home <i class="fa fa-flag"></i></a></li>
			<li><a href="master-section-landing.php">Master Section Landing <i class="fa fa-flag"></i></a></li>
		</ul>
	</div>
	<div class="col-md-4">
		<ul>
			<li><a href="mixed-media.php">Mixed Media <i class="fa fa-flag"></i></a></li>
			<li><a href="profile.php">Profile <i class="fa fa-flag"></i></a></li>
			<li><a href="basic-profile.php">Profile (basic) <i class="fa fa-flag"></i></a></li>
			<li><a href="student-life.php">Student Life <i class="fa fa-flag"></i></a></li>
			<li><a href="why-simons-rock.php">Why Simon's Rock <i class="fa fa-flag"></i></a></li>
		</ul>
	</div>
</div>
...
<ul>
	...
	<li><a href="/contact-form-pages/contact-form.php">Contact-Form</a></li>
</ul>

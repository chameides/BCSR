    ...
    <div class="container-fluid page-container">
      ...
      <div class="section-full-screen-wrapper">
        <section class="slat-network section-full-screen">
          <div class="container abscontainer">
            <div class="intro_sub">
              <img src="/_images/cec/map-network/our-network-770.png" class="hidden-sm hidden-md hidden-lg">
      ...
      <div class="col-xs-12 highlights-grid">
        <h2 class="text-center">
          Leading The Way To Early College
        </h2>
        <div class="col-sm-4 form-group"> 
          <div class="text-center">
            <h3>Pedagogy</h3>
            <h4>Liberal arts, critical thinking</h4>
            <a class="btn btn-primary" href="#">Pedagogy Resources</a>
          </div>
          <br>
        </div>
        <div class="col-sm-4 form-group"> 
          <div class="text-center">
            <h3>Public Policy</h3>
            <h4>Writing and advocating for a better education system</h4>
            <a class="btn btn-primary" href="#">Policy Initiatives</a>
          </div>
          <br>
        </div>
         <div class="col-sm-4 form-group"> 
          <div class="text-center">
            <h3>Partnerships</h3>
            <h4>Collaborating to improve and expand early college</h4>
            <a class="btn btn-primary" href="#">Partnerships</a>
          </div>
        </div>
      </div> 
...
<section id="reputations_outcomes">
    ...
    <div class="container-fluid">
      ...
      <div class="viewall_container drop_on_mobile"><a id="reps_outcomes_btn" class="btn btn-primary">Early College Outcomes </a></div>

...
(function() {
  ...
  s.ee = function() {
    for (var a = this.c.textTracks, c, d = a.length, e = {
      ...
      if ((c = a[d]) && c.kind in e) c.mode = "disabled"
  };
  s.Wd = function(a) {
  ...
  t.aa = t.M.extend({
    l: function(a, c) {
      var d = this.U = c.track,
        e = a.textTracks(),
        g, h;
      e && (g = t.bind(this, function() {
        var a = "showing" === this.U.mode,
          c, d, g;
        if (this instanceof t.Ab) {
          a = f;
          d = 0;
          for (g = e.length; d < g; d++)
            if (c = e[d], c.kind === this.U.kind && "showing" === c.mode) {
              a = l;
              break
            }
        }
  ...
  t.aa.prototype.u = function() {
    ...
    t.M.prototype.u.call(this);
    if (c)
      for (; e < c.length; e++) d = c[e], d.kind === a && (d.mode = d === this.U ? "showing" : "disabled")
  };
  t.Ab = t.aa.extend({
    l: function(a, c) {
      c.track = {

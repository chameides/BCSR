...
<div class="row">
	...
	<div class="col-md-6">
		<?php include 'contact-form-fields-discovery.php'; ?>
...
<!--call Hobson script with parameter-->
<script id="hobson-form-submit" data-name="discovery" src="/_resources/js/forms/rfi-combine-min.js"></script>

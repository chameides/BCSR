<div class="row"><!-- row inside the col -->
	<form id="contactForm">
		...
		<div id="grpPhoneType" class="form-group checkbox-sub col-sm-6"><label for="drpPhoneType">Phone Type</label><select id="drpPhoneType" class="form-control" name="drpPhoneType" required="required">

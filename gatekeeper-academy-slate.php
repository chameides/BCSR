<!--change log
compared to gatekeeper.php
1. change navbar-brand-gatekeeper - href and src
-->
<!DOCTYPE html>
<html lang="en">
  <head>
      ...
      <div class="row-full-width">
        <div class="page-hero-container page-hero-container-small gatekeeper-bg">
          ...
          <div class="page-hero-gateway-alt text-center">
            <div class="navbar-brand-gatekeeper-academy">
              <a href="http://simons-rock.edu/academy/index.php" title="Bard Academy at Simon's Rock">
                <img src="/_images/logos/basr_primary_print-white-200w.png" alt="Bard Acdemy at Simon's Rock">
              </a>
            </div>
          ...
          <div class="row row-highlight">
            <div class="col-sm-6 row-col-highlight">
              ...
              <div style="clear: both;">
                <div id="form_7c83951b-74e7-4985-ae1b-7c74f77af05e">Loading...</div><script>/*<![CDATA[*/var script = document.createElement('script'); script.async = 1; script.src = 'https://apply.simons-rock.edu/register/?id=7c83951b-74e7-4985-ae1b-7c74f77af05e&output=embed&div=form_7c83951b-74e7-4985-ae1b-7c74f77af05e' + ((location.search.length > 1) ? '&' + location.search.substring(1) : ''); var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(script, s);/*]]>*/</script>
              </div>
            </div>
            <div class="col-sm-6">

...
<head>
	...
	<title>'.CalName.', powered by OU Calendar</title>
...
'.((isset($_SESSION['AdminLoggedIn'])) ? '<body>' : '<body class="login">');
	...
	echo '
	<div id="footer">
		'.CalName.'<br /><a href="http://omniupdate.com/products/oucampus/modules/oucalendar.html" target="_blank">OU Calendar powered by Helios '.HCVersion.'</a>
	</div>
</body>
</html>';
?>
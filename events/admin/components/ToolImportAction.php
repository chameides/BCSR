			...
			if(in_array("SUMMARY",$matches)){
				...
				while($i < count($matches)){
					...
					if(strrpos($matches[$i],"DESCRIPTION") === 0){
						...
						$description = preg_replace("/______________________________Calendar Subscription Powered by OU Calendar/","",$description);
						$description = preg_replace("/______________________________This Event Downloaded From a OU Calendar Powered Site/","",$description);
					}

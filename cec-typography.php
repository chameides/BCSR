...
<div class="container-fluid page-container">
  <div class="column-center"> 
    ...
    <p>The body copy is set in Helvetica Neue Condensed - clean, contemporary, and yet neutral. Headers are set in Freight Neo. The Sans Serif complements the contemporary feel of the body copy. The notches and mixed-width reference humanism and the renaissance, creating a serious, yet warm feel.</p>
  ...
  <div class="row stacked-content">
    ...
    <div class="col-sm-9">
      <div class="arrow-list-tight-small-wrapper">
        <h4 class="spotlight">Bard High School Early College Manhattan</h4>
        <p>Enrollment:<br>
        Founding year: 2001<br>
        Director: Michael Lerner<br>
        AA Graduation Rate: <br>
         <a href="/why-simons-rock/contact-us/offices-and-departments/business-office.php"> <i class="fa fa-link"></i> Program Website</a></p>
      </div>
    </div>
  </div>
	<div class="row stacked-content">
    ...
    <div class="col-sm-9">
      <div class="arrow-list-tight-small-wrapper">
        <h4 class="spotlight">School Name</h4>
        <p>Enrollment: #<br>
